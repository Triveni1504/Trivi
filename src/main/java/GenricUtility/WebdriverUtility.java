...
public class WebdriverUtility {
    ...
    public void scrolldownn(WebDriver driver) {
    	JavascriptExecutor jse=(JavascriptExecutor)driver;
    	jse.executeScript("window.scrollBy(0,2000);");
    }
    public void scrolldown8(WebDriver driver) {
    	JavascriptExecutor jse=(JavascriptExecutor)driver;
    	jse.executeScript("window.scrollBy(0,800);");
    }
    public void scrolldown0(WebDriver driver) {
    	JavascriptExecutor jse=(JavascriptExecutor)driver;
    ...
    public void scrolldown03(WebDriver driver) 
    {
    	JavascriptExecutor jse=(JavascriptExecutor)driver;
    ...
    public void switchtoChildWindow(WebDriver driver, String ParentWindow, Set<String> ChildWindow) {
